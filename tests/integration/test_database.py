...
DB_URL = os.environ.get("TEST_DATABASE_URL", "postgresql+asyncpg://aura:aura@localhost:5432/aura")
if "sqlite" in DB_URL:
    raise RuntimeError("Integration tests MUST run against PostgreSQL. SQLite fallback is disabled.")
