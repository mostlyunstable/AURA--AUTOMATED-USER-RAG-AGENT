...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('task_execution_id', sa.Uuid(), sa.ForeignKey('task_executions.id'), nullable=False),
    ...
    op.create_index('ix_verification_results_task_execution_id', 'verification_results', ['task_execution_id'])


def downgrade() -> None:
    """Downgrade schema."""
    op.drop_index('ix_verification_results_task_execution_id', table_name='verification_results')
    op.drop_index('ix_verification_results_agent_run_id', table_name='verification_results')
