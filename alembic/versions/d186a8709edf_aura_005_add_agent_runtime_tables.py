...
def upgrade() -> None:
    ...
    op.add_column('agents', sa.Column('agent_type', sa.String(50), nullable=False, server_default='CODING_AGENT'))
    ...
    op.create_index('ix_agent_runs_task_execution_id', 'agent_runs', ['task_execution_id'])
